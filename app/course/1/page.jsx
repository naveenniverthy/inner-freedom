...
export const metadata = {
  title: "What Are You Really Seeking? - Foundations of Self-Knowledge",
  description:
    "Begin Foundations of Self-Knowledge with a reflection on desire, dissatisfaction, and what we are truly seeking.",
};
